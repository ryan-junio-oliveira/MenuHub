        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div class="lg:col-span-2 space-y-6">
                <x-card padding="6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input id="date" name="date" type="date" placeholder="Selecione a data" class="mt-1.5 block w-full input-field" :value="old('date')" required />
                            <x-input-error :messages="$errors->get('date')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="max_selections" value="{{ __('Máx. Seleções por Pedido') }}" />
                            <x-text-input id="max_selections" name="max_selections" type="number" placeholder="Limite de seleções" class="mt-1.5 block w-full input-field" :value="old('max_selections', 3)" required />
                ...
                <x-card padding="6">
                    ...
                    <p class="text-sm text-text-secondary dark:text-slate-400 mb-5">{{ __('Selecione as opcoes disponiveis para o marmitex (sem preco fixo).') }}</p>
